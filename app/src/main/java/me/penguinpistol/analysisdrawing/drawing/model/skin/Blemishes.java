 ...
 * 점 - 잡티
 */
public class Blemishes extends BaseDrawingModel {

    public Blemishes(@NonNull Context context, @NonNull List<PointF> landmark118, @NonNull List<PointF> landmark171) {
