 ...
 * 주름 - 눈밑주름
 */
public class EyeWrinkle extends BaseDrawingModel {

    public EyeWrinkle(@NonNull Context context, @NonNull List<PointF> landmark118, @NonNull List<PointF> landmark171) {
    ...
    protected void parseJson(JsonElement json) {
        // lab_origin.data.details.common.skinEyeWrinkleLeftPathPointsValue
        // lab_origin.data.details.common.skinEyeWrinkleRightPathPointsValue
    }
}
